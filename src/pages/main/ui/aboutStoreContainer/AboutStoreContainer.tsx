  ...
  return (
    <div className={styles.aboutStoreContainer}>
      <div className={styles.aboutStoreText}>
        ...
        <p>
          &quot;Stones Fall&quot; is a store where you can purchase a wide variety of gemstones, faceted stones, beads,
          crystals, pebbles, and other stone products.
        </p>
        <p>
          Our store offers a diverse range of stones in different shapes, colors, and sizes. You will find precious and
          semi-precious gemstones, natural and lab-created stones, cut and uncut specimens. &quot;Stones Fall&quot;
          provides stones for collecting, creating jewelry, using in meditation and rituals, as well as for decorative
          and esoteric purposes.
        </p>
        <p>
        ...
        <p>
          ...
          properties, and ways to incorporate them into your life. We strive to provide a unique experience of immersing
          yourself in the world of stones and their energy.
        </p>
      </div>
